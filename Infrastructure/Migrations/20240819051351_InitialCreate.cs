    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LyricChords", x => new { x.SongId, x.ChordId, x.CharacterIndex });
                    table.ForeignKey(
                        name: "FK_LyricChords_Chords_ChordId",
                        column: x => x.ChordId,
                        principalTable: "Chords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LyricChords_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LyricChords_ChordId",
                table: "LyricChords",
                column: "ChordId");

            migrationBuilder.CreateIndex(
                name: "IX_Songs_LyricId",
                table: "Songs",
                column: "LyricId");
